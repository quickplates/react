...
[`.github/workflows/lint.yaml`](https://github.com/quickplates/react/blob/main/.github/workflows/lint.yaml).
...
You can find the `GitHub Actions` workflow that does this in
[`.github/workflows/test.yaml`](https://github.com/quickplates/react/blob/main/.github/workflows/test.yaml).
